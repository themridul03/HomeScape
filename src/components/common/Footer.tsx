        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="HomeScape" className="h-10 w-auto brightness-0 invert" />
              <span className="font-fraunces text-2xl font-bold">HomeScape</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+9199999999" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Phone className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>+91 99999 22222</span>
                </a>
              </li>
              <li>
                <a href="mailto:hello@HomeScape.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>hello@HomeScape.com</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 HomeScape. All rights reserved. Powered by AI.
            </p>
